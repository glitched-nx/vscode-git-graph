...
class Config {
	...
	get contextMenuActionsVisibility(): ContextMenuActionsVisibility {
		...
		const config: ContextMenuActionsVisibility = {
			branch: { checkout: true, rename: true, delete: true, merge: true, rebase: true, push: true, submodule: true, viewIssue: true, createPullRequest: true, createArchive: true, selectInBranchesDropdown: true, unselectInBranchesDropdown: true, copyName: true },
			...
			remoteBranch: { checkout: true, delete: true, fetch: true, merge: true, pull: true, submodule: true, viewIssue: true, createPullRequest: true, createArchive: true, selectInBranchesDropdown: true, unselectInBranchesDropdown: true, copyName: true },
			stash: { apply: true, createBranch: true, createPatch: true, pop: true, drop: true, copyName: true, copyHash: true },
